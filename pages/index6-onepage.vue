<template>
  <NuxtLayout name="ygency" :footer="6" :header="1" :singlePage="true">
    <!-- Hero Section Start -->
    <section
      id="home"
      class="hero-area-six pt-185 rpt-150 pb-130 rpb-100 rel z-1"
    >
    ...
    <!-- Services area start -->
    <div id="scroll-down" class="services-area-five bgc-primary pt-80 pb-50">
      <div class="container">
    ...
    <section
      id="about"
      class="about-area-six pt-130 rpt-100 pb-80 rpb-50 rel z-1"
    >
      <div class="container">
    ...
    <!-- Services Area start -->
    <section id="services" class="services-area-six pb-100 rpb-70 rel z-1">
      <div class="container">
    ...
    <!-- Team Area start -->
    <section id="team" class="team-area pt-130 rpt-100 pb-100 rpb-70 rel z-1">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div
    ...
    <!-- Projects Area start -->
    <section id="projects" class="project-area-six pt-100 rpt-70 rel z-1">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <div
    ...
    <section
      id="blog"
      class="blog-area-two pt-125 rpt-100 pb-70 rpb-40 rel z-1"
    >
      <div class="container">
        <div class="row justify-content-center">
