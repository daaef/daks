<template>
  <NuxtLayout name="ygency" :header="1" :footer="1" :singlePage="true">
    ...
    <section id="news" class="blog-area pt-125 rpt-100 pb-70 rpb-40 rel z-2">
      <div class="container container-1290">
        <div class="row justify-content-center">
          <div class="col-xl-8 col-lg-10">
            <div
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-item wow fadeInUp delay-0-2s">
              ...
              <div class="image">
                ...
                <NuxtLink class="details-btn" href="blog-details"
                  ><i class="far fa-arrow-right"></i
                ></NuxtLink>
              </div>
            </div>
      ...
      <div class="blog-bg">
        <img src="/assets/images/background/counter-bg.png" alt="Blog BG" />
      </div>
    </section>
    <!-- Blog Style Two end -->
  </NuxtLayout>
